    ...
    <div className="flex flex-col items-center mt-10 mb-10">
      ...
      <div className="grid grid-cols-5 gap-6 mb-6 mt-6 ml-10 mr-10">
        {doctors.slice(0,10).map((doctor,index) => (
            <div key={index} className="border border-gray-200 rounded-lg hover:shadow-lg transition-transform hover:translate-y-1 duration-300 mb-4">
      ...
      <button className="bg-gray-200 px-8 py-2 rounded-full text-lg flex flex-row items-center">more <HiOutlineDotsHorizontal className="ml-1"/></button>
    </div>
  )
}
