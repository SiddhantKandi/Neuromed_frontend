    ...
    <div className="flex flex-row bg-indigo-700 rounded-lg ml-20 mr-20 mx-auto p-4">
      {/*Left Side */}
        <div className="flex flex-col w-7/12 items-center justify-center">
            <p className="text-white md:text-3xl font-semibold items-center  sm:text-xl">Book Appointments with Trusted Doctors</p>
            <div className="flex flex-row mt-2 ml-5">
                <img src={assets.group_profiles} alt="group profiles" className="md:block hidden"/>
